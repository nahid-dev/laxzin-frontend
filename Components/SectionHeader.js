...
const SectionHeader = ({ title, className, subtitle }) => {
  return (
    <div className={`text-center mb-6 md:mb-10 lg:mb-12 ${className}`}>
      ...
      <h2 className="text-xl md:text-4xl font-thin mb-0 sm:mb-3 tracking-[0.15em] sm:tracking-[0.25em] bg-gradient-to-r from-gray-600 via-black to-gray-600 bg-clip-text text-transparent relative transition-all duration-500 hover:bg-gradient-to-r hover:from-black hover:via-gray-600 hover:to-black">
        {title}
        {/* Underline accent */}
