    ...
    >
      ...
      <section aria-labelledby="price-heading">
        ...
        <div className="grid grid-cols-2 gap-2 mb-1">
          <div>
            <label className="block mb-1 text-xs text-gray-600">Min</label>
            <input
              type="number"
          ...
          <div>
            <label className="block mb-1 text-xs text-gray-600">Max</label>
            <input
              type="number"
              className="w-full px-2 py-1 text-sm bg-white border border-gray-300 rounded"
              value={price.max}
      ...
      {catItems?.length > 0 && (
        <section aria-labelledby="cat-heading">
          ...
          <ul className="pr-1 space-y-2 overflow-auto max-h-48">
            ...
            {catItems.length === 0 && (
              <li className="text-xs text-gray-500">No categories</li>
            )}
          </ul>
        </section>
      )}
